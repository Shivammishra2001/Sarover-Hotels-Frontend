...
export function HomeCtaButton({
  ...
  return (
    <Link
      href={href}
      className={cn(
        " items-center justify-center rounded-full bg-[#c1392a] px-10 py-5 text-[13px] font-extrabold uppercase tracking-[0.78px] text-white transition-colors hover:bg-[#c1392a]/90 lg:px-[60px] lg:py-[20px]",
        className
      )}
    >
      {children}
